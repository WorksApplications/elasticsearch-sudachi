...
/**
 * OpenSearch 3.0+ XContent aliases.
 *
 * OpenSearch moved xcontent classes between packages across versions, so we keep these typealiases
 * version-scoped under src/main/ext.
 */
