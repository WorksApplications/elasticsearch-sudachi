...
abstract class AbstractTokenizerFactory(
    ...
    name: String?,
    settings: Settings?
) : org.elasticsearch.index.analysis.AbstractTokenizerFactory(name!!)
...
abstract class AbstractTokenFilterFactory(
    ...
    name: String?,
    settings: Settings?
) : org.elasticsearch.index.analysis.AbstractTokenFilterFactory(name!!)
...
abstract class AbstractIndexAnalyzerProvider<T : Analyzer>(
    ...
    name: String?,
    settings: Settings?
) : org.elasticsearch.index.analysis.AbstractIndexAnalyzerProvider<T>(name!!)
