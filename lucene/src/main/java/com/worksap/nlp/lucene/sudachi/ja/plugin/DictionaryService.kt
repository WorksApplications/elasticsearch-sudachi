...
public class ReloadableDictionary(private val config: Config) : CurrentDictionary {
...
public class DictionaryService(additionalClassloaders: List<ClassLoader> = emptyList()) {
